...
def predict_on_file(model_path, label_path, target_excel, predict_results_path):
    ...
    joblib.dump(log,model_path)  #r'E:/文本挖掘/工作三-工艺抽取/段落分类/101段落标记分类/model/log_2.pkl'
...
# predict_on_file(r"/data/home/scv4785/run/wwr/text_classification/code/tfidf_out/model/tfidf_log",r"/data/home/scv4785/run/wwr/text_classification/code/tfidf_out/label.csv",r"/data/home/scv4785/run/wwr/text_classification/code/tfidf_out/all_paragraphs_predicted.xlsx",r"/data/home/scv4785/run/wwr/text_classification/code/tfidf_out/tfidf_predict_results.xlsx")
get_accuracy_f1(lable_path,10)


# csv_data = pd.read_csv(r'E:/文本挖掘/工作三-工艺抽取/段落分类/101段落标记分类\label_corpus.csv')
# df = pd.DataFrame(csv_data)
# df_shape = df.shape
# length = df_shape[0]
# outcome={}
...
# # y_train, X_train = get_vectors(bow_vectorizer, train_tagged, doc_label)
# y_test, X_test = get_vectors(bow_vectorizer, test_tagged, doc_label)
# log = LogisticRegression(max_iter=1000).fit(X_test, y_test)
# # joblib.dump(log,r'E:/文本挖掘/工作三-工艺抽取/段落分类/101段落标记分类/model/log_2.pkl')
#
# # 利用本地向量进行预测
# import xlrd
#
# new_data = xlrd.open_workbook(r"E:/文本挖掘/工作三-工艺抽取/段落分类/101段落标记分类/test/elsevier.xlsx")
...
#     sht.cell(col_i,2,tag) # 写入表格的只能是字符型数据
#     col_i += 1
# xls.save(r'E:/文本挖掘/工作三-工艺抽取/段落分类/101段落标记分类/model\Elsevier.xlsx')