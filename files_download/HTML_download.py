...
def getHtml(url):
    html = None
    headers = {
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3874.400 QQBrowser/10.8.4480.400',
        'Cookie': 'I2KBRCK=1'}  # ,'Cookie': 'I2KBRCK=1'
    try:
        req = urllib.request.Request(url=url, headers=headers)
